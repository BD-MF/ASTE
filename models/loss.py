...
class Loss(nn.Module):
    ...
    def __init__(self, args):
        super().__init__()
        self.use_coverage = args.is_coverage
        # hyperparameter lambda in Eq. (13)
        self.cov_weight = args.cov_loss_wt
        self.pad_id = args.PAD
        self.args = args
    ...
    def nll_loss(self, output, target):
        ...
        """
        output = torch.log(output).to(self.args.device)
    ...
    def cov_loss(self, attn_dist, coverage, dec_pad_mask, dec_len):
        ...
        dec_pad_mask = dec_pad_mask.to(self.args.device)
